...
| 용도      | 글꼴                  | 비고                             |
| --------- | --------------------- | -------------------------------- |
| 본문·헤딩 | 나눔고딕(NanumGothic) | 미설치 PC에서는 Word가 자동 대체 |
| 코드      | D2Coding              | 한글 폭이 고정된 코딩용 글꼴     |

> 두 글꼴 모두 무료입니다. 독자/공유 대상 PC에 없으면 Word가 비슷한 글꼴로 대체해 보여주므로
...
| --------------------- | --------------------------- | -------- | ------ | -------- | -------------------------------------------------- |
| 문서 제목             | Title                       | 나눔고딕 | 28pt   | `C5170A` | 굵게                                               |
| 부제                  | Subtitle                    | 나눔고딕 | 14pt   | `6B7280` |                                                    |
| `#` 제목 1            | Heading 1 (제목 1)          | 나눔고딕 | 20pt   | `C5170A` | 굵게, 아래 0.5pt 레드 보더                         |
| `##` 제목 2           | Heading 2 (제목 2)          | 나눔고딕 | 16pt   | `A21309` | 굵게                                               |
| `###` 제목 3          | Heading 3 (제목 3)          | 나눔고딕 | 14pt   | `374151` | 굵게                                               |
| `####` 제목 4         | Heading 4                   | 나눔고딕 | 12pt   | `374151` | 굵게                                               |
| `#####` 제목 5        | Heading 5                   | 나눔고딕 | 11pt   | `4B5563` | 굵게                                               |
| `######` 제목 6       | Heading 6                   | 나눔고딕 | 10.5pt | `6B7280` | 굵게·이탤릭                                        |
| 본문 문단             | Normal / Body Text (표준)   | 나눔고딕 | 10.5pt | `1A1A1A` | 줄간격 1.4                                         |
...
| 인용/팁 `>`           | Block Text                  | 나눔고딕 | 10.5pt | `374151` | 좌측 레드(`C5170A`) 바, 배경 `FCF3F2`              |
| 링크                  | Hyperlink                   | (상속)   | —      | `1D4ED8` | 밑줄                                               |
| 목차 제목             | TOC Heading                 | 나눔고딕 | 18pt   | `C5170A` | 굵게                                               |
| 그림/표 캡션          | Caption / Image Caption     | 나눔고딕 | 9pt    | `6B7280` | 이탤릭·가운데                                      |
